    ...
    public class HonestMarkClient
    {
        ...
        private HonestMarkClient()
        {
            if (UtilitesLibrary.ConfigSet.Config.GetInstance().ProxyEnabled)
                _webService = new WebService.ServiceManager(UtilitesLibrary.ConfigSet.Config.GetInstance().ProxyAddress,
        ...
        public bool Authorization(X509Certificate2 certificate, EdiProcessingUnit.Edo.Models.Kontragent organization = null)
        {
            ...
            var authData = _webService.GetRequest<Models.AuthData>($"{_urlAddressHonestMark}/auth/key");

            var crypto = new Cryptography.WinApi.WinApiCryptWrapper(certificate);
            ...
            var result = _webService.PostRequest<Models.AuthResult>($"{_urlAddressHonestMark}/auth/simpleSignIn",
        ...
        public string CreateDocument(ProductGroupsEnum productGroup, DocumentFormatsEnum documentFormat, string codeDocType, IDocument documentData)
        {
            ...
            var crypto = new Cryptography.WinApi.WinApiCryptWrapper(_certificate);
            ...
            var url = $"{_urlAddressHonestMark}/lk/documents/create?pg={productGroupStr}";
        ...
        public Models.ReprocessDocumentResponse ReprocessDocument(string docId)
        {
            ...
            var url = $"{_urlAddressHonestMark}/document/reprocess";
        ...
        public Models.MarkCodeInfo[] GetMarkCodesInfo(ProductGroupsEnum productGroup, string[] markCodes)
        {
            ...
            var markCodesInfos = _webService.PostRequest<Models.MarkCodeInfo[]>($"{_urlAddressHonestMark}/cises/info{productGroupStr}",
        ...
        public Models.DocumentInfo GetDocumentInfo(ProductGroupsEnum productGroup, string docId)
        {
            ...
            var docInfo = _webService.GetRequest<Models.DocumentInfo>($"{_urlAddressHonestMark}/doc/{docId}/info?pg={productGroupStr}", authData);
        ...
        public Models.DocumentEdoProcessResultInfo GetEdoDocumentProcessInfo(string docId)
        {
            ...
            var docInfo = _webService.GetRequest<Models.DocumentEdoProcessResultInfo>($"{_urlAddressHonestMark}/documents/edo/tpr/ud?fileId={docId}", authData);
